      ...
      <nav className="fixed top-0 left-0 w-full z-50 px-4 sm:px-6 py-4 sm:py-8 flex justify-between items-center pointer-events-none">
        ...
        <a href="/" className="pointer-events-auto">
          <motion.div
            ...
            className="text-xl sm:text-2xl font-extrabold tracking-tighter flex items-center gap-2 cursor-pointer relative"
          >
            {/* Glow */}
            <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-[#db5627] blur-[4px] absolute -z-10 animate-pulse" />

            {/* Logo Image */}
            <img
              src="/white-logo.jpeg"
              alt="Codevamp logo"
              className="w-6 h-6 sm:w-10 sm:h-10 object-contain rounded-full"
            />
